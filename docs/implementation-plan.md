...
- `/` — the complete artifact story, repeated animated day counters and runners, illustrated commitment, founder story, initiatives, money handling and ledger, animated goals, horizontal race timeline, winding checkpoint trail, private spending analyser, live Strava/kilometre sponsor pairing, race voting preview, six-card habit challenge, Instagram, and coffee/help form.
